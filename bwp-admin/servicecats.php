...
if ($_SESSION['loggedin'] == true) {
    ...
    if ($userKont['loginID'] == $_SESSION['loginid']) {
        $pageTitle = "Hizmetler Kategori Yönetimi";
        $mpage = "content";
        $maltpage = "service";
        $mlink = "cats";
        $process = $_GET['process'];
        $processTitle = "Hizmetler Kategori Yönetimi";
        if ($process == "edit") {
            $db->where("id", $_GET["id"]);
            $editP = $db->getOne("servicecat");
        }
?>
        <!DOCTYPE html>
        <html lang="tr">
        ...
        <body class="kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-aside--enabled kt-aside--fixed kt-page--loading">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <?php
                                                                ...
                                                                ?>
                                                                    <div class="col-lg-12">
                                                                        <img src="../bwp-content/uploads/hizmet/<?php echo $gen; ?>x<?php echo $yuk . '/' . $editP['resim']; ?>" class="img-thumbnail">
                                                                    </div>
                                                                <?php
                                                                }
                                                                ?>
            ...
            <script>
                ...
                function table() {
                    ...
                    $.ajax({
                        url: '../bwp-includes/ajax.php?i=service&process=view',
                        type: 'POST',
                        data: data,
                        success: function(e) {
                            var obj = jQuery.parseJSON(e);
                ...
                function pageset(id, type) {
                    ...
                    $.ajax({
                        url: '../bwp-includes/ajax.php?i=service&process=set',
                        type: 'POST',
                        data: data,
                        xhr: function() {
                ...
                $(document).on("click", "button[name=set]", function() {
                    console.log($("input[name=slide]").val());
                    var id = $(this).data("id");
