                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control" name="title" placeholder="İçerik başlığı" value="<?php echo $post['post_title'];?>">
                                            ...
                                            <div class="accordion accordion-solid accordion-panel accordion-toggle-svg" id="accordionExample8">
                                                <div class="card">
                                                    ...
                                                    <div id="collapseOne8" class="collapse show" aria-labelledby="headingOne8" data-parent="#accordionExample8">
                                                        <div class="card-body">
                                                            <div class="row d-none file-prog">
                                                                <div class="mb-4 col-lg-12">
                                                                    <label>Dosyaların yükleme durumu</label>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="mt-4 col-md-12">
                                                                    <div class="custom-file">
                                                                        ...
                                                                        <label class="custom-file-label" for="customFile">Resim dosyası seçiniz</label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div id="collapseTwo8" class="collapse show" aria-labelledby="headingTwo8" data-parent="#accordionExample8">
                                                        <div class="card-body">
                                                            <?php if($process == "edit"){ if(count($pdf)>0)?>
                                                                <div class="col-lg-12">
                                                                    <a href="../bwp-content/uploads/posts/pdf/<?php echo $pdf['type_meta'];?>" target="_blank">PDF görüntülemek için tıklayın</a>
                                                                </div>
                                                            <?php }?>
                                                            <div class="mt-4 col-md-12">
                                                                <div class="custom-file">
