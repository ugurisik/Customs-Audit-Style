    ...
    if($userKont['loginID'] == $_SESSION['loginid']){
                    ...
                    <div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
                        <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
                            <div class="row">
                                ...
                                <div class="col-md-4" id="kt_sortable_portlets">
                                    <div class="row">
                                        <div class="col-sm-12">
                                                            ...
                                                            <div class="col-sm-12">
                                                                ...
                                                                <div class="dropzone dropzone-default" id="kt_dropzone_1">
                                                                    <div class="dropzone-msg dz-message needsclick">
                                                                        ...
                                                                        <?php if($process == "edit"){?>
                                                                            <img class="w-100" src="../bwp-content/uploads/service/<?php echo $boyut; ?>/<?php echo $image['type_meta'];?>">
                                                                        <?php }?>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                        ...
                                                                        foreach ($catAltList as $cap) {
                                                                            ...
                                                                            foreach ($catAltList as $cap) {
                                                                                ...
                                                                                foreach ($catAltList as $cap) {
                                                                                    ...
                                                                                    $postcat = $db->getOne ("education_meta");
                                                                                    if($postcat['type_meta'] == $cap['id']){
                                                                                        echo '<label class="col-md-12 kt-checkbox kt-checkbox--bold kt-checkbox--dark" style="margin-left:60px">
                                                                                    <input type="checkbox" name="cat" value="'.$cap['id'].'" checked> '.$cap['title'].'
                                                                                    <span></span>
                                                                                </label>';
                                                                                    }else {
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <div class="form-group float-right">
                                                                    <?php if($process == "edit"){?>
                                                                        <button type="button" class="btn btn-dark" data-id="<?php echo $editP['id'];?>" data-type="educationEdit" name="set"><i class="fa fa-edit"></i> Düzenle</button>
                                                                    <?php }else{?>
                                                                        <button type="button" class="btn btn-success"  data-type="educationAdd" name="set" ><i class="fa fa-plus"></i> Ekle</button>
                                                                    <?php }?>
                                                                </div>
                                                            </div>
                                                        </div>
        ...
        <script>
            ...
            function catList(langID){
                var data = [];
                data.push({name : "langID",value : langID},{name : "type",value : "catList"});
                $.ajax({
            ...
            jQuery(document).ready(function() {
                ...
                $(document).on("click","button[name=set]", function(){
                    ...
                    var dataString = {type:tip,id:id,title:baslik,image:resim,content:""+icerik+"",cat: cat.toString(),durum:durum,langID:langID,author: <?php echo $userKont['id'];?>,date: "<?php echo $tarih;?>"};
                    $.ajax({
                ...
                <?php if($process == "edit"){?>
                dropzonejs("../bwp-includes/ajax.php?i=imgedit","service");
                <?php }else{?>
                dropzonejs("../bwp-includes/ajax.php?i=imgadd","service");
                <?php }?>
            });
        </script>
        </body>
