                            ...
                            ?>
                                    <div class="col-lg-4 offset-lg-0 col-md-6 offset-md-0 col-sm-8 offset-sm-2 col-12">
                                        <div class="single-page-blog">
                                            ...
                                            <div class="content">
                                                <h4 class="title"><a href="<?php echo $db->translate("yazi"); ?>/<?php echo $post['post_slug']; ?>/"><?php echo $yazi->kisalt($post['post_title'], 45)  ?></a></h4>
                                                <p class="text"><?php echo strip_tags($yazi->kisalt($post['post_content'], 170), HTML_SPECIALCHARS); ?></p>
                                                <a class="more" href="<?php echo $db->translate("yazi"); ?>/<?php echo $post['post_slug']; ?>/"><?php echo $db->translate("devaminioku"); ?> <span><i class="fas fa-angle-right"></i></span></a>
                                            </div>
                                        </div>
                                    </div>
                            <?php }
