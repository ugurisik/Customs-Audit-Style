...
(function (d, f, g, a) {
  ...
  h.prototype = {
    _init: function () {
      var k = this;
      k.eeelement.find(".pogoSlider-slide").each(function () {
        var n = [];
        var o = 0;
      ...
      k.slides[0].eeelement.css("opacity", 1);
      ...
      var j = k.eeelement.find("img").length;
      if (j > 0) {
        var l = 0;
        k.eeelement.prepend(
    ...
    _onSliderReady: function () {
      ...
      if (j.settings.pauseOnHover) {
        j.eeelement.on("mouseenter", function () {
          j.pause();
        });
        j.eeelement.on("mouseleave", function () {
          j.resume();
        });
      }
      j._onSlideStart(0);
    ...
    _createDirButtons: function () {
      var j = this;
      j.eeelement.addClass("pogoSlider--dir" + j.settings.buttonPosition);
      d('<button class="pogoSlider-dir-btn pogoSlider-dir-btn--prev"></button>')
        .appendTo(j.eeelement)
        .on("click", function () {
          j.prevSlide();
        });
    ...
    _createNavigation: function () {
      var j = this;
      j.eeelement.addClass("pogoSlider--nav" + j.settings.navPosition);
      var l = d('<ul class="pogoSlider-nav"></ul>').appendTo(j.eeelement);
    ...
    _preserveTargetSize: function () {
      ...
      var m = 1;
      if (this.scaledBy) {
        m = this.eeelement.width() / this.settings.targetWidth / this.scaledBy;
      } else {
        m = this.eeelement.width() / this.settings.targetWidth;
      }
      this.scaledBy = this.eeelement.width() / this.settings.targetWidth;
      this.eeelement.find(".pogoSlider-slide-element").each(function () {
    ...
    _createProgessBar: function () {
      ...
      for (var j = 0; j < this.slides.length; j++) {
        this.slides[j].eeelement.prepend(k);
      }
    },
    ...
    pause: function () {
      if (this.settings.autoplay) {
        ...
        if (this.settings.displayProgess) {
          this.eeelement.find(".pogoSlider-progressBar-duration").stop(true);
        }
        ...
        for (
          ...
          this.slides[this.currentSlideIndex].children[j].eeelement.precss(
    ...
    _onSlideStart: function (k) {
      ...
      if (this.paused) {
        for (var j = 0; j < this.slides[k].children.length; j++) {
          this.slides[k].children[j].eeelement.precss(
            "animation-play-state",
            "paused"
          );
        }
    ...
    _onSlideEnd: function (l) {
      ...
      if (this.paused) {
        ...
        for (var j = 0; j < this.slides[l].children.length; j++) {
          this.slides[l].children[j].eeelement.precss(
            "animation-play-state",
            ""
          );
        }
    ...
    _slideCleanup: function (k, j) {
      if (this.slides[k].eeelement.find(".pogoSlider-slide-slice").length > 0) {
        this._removeSlideSlices(k);
      }
      this.slides[k].eeelement
        .attr("style", this.slides[k].eeelement.data("original-styles"))
        .css("opacity", j ? "1" : "0");
    },
    _slideElementCleanup: function (m) {
      ...
      this.slides[m].eeelement
        .find(".pogoSlider-progressBar-duration")
        .css("width", "0");
      for (var k = 0; k < this.slides[m].children.length; k++) {
        this.slides[m].children[k].eeelement
          .removeClass(j)
          .attr("style", l)
          .css("opacity", 0);
      }
    ...
    _createSlideSlices: function (A, q, r) {
      ...
      if (
        ...
        for (var x = 0; x < this.slides[A].children.length; x++) {
          ...
          this.slides[A].children[x].eeelement.precss("animation-delay", k);
        }
      }
      C.children()
        .wrapAll(
      ...
      for (var w = 0; w < p; w++) {
        ...
        if (this.settings.preserveTargetSize) {
          y =
            "background-size:" +
            this.eeelement.width() +
            "px " +
            parseFloat(this.eeelement.css("padding-bottom")) +
            "px;";
          console.log(y);
        }
    ...
    slideTransitions: {
      fade: function (j, l) {
        var k = this.slides[l];
        this.slides[j].eeelement.precss({
          "*opacity": "0",
      ...
      slideLeft: function (k, m) {
        ...
        return function () {
          j.slides[k].eeelement.removeClass("pogoSlider-animation-leftOut");
          l.eeelement
            .attr("style", l.eeelement.data("original-styles"))
            .css("opacity", "1")
      ...
      slideRight: function (k, m) {
        ...
        return function () {
          j.slides[k].eeelement.removeClass("pogoSlider-animation-rightOut");
          l.eeelement
            .attr("style", l.eeelement.data("original-styles"))
            .css("opacity", "1")
      ...
      slideUp: function (k, m) {
        ...
        return function () {
          j.slides[k].eeelement.removeClass("pogoSlider-animation-upOut");
          l.eeelement
            .attr("style", l.eeelement.data("original-styles"))
            .css("opacity", "1")
      ...
      slideDown: function (k, m) {
        ...
        return function () {
          j.slides[k].eeelement.removeClass("pogoSlider-animation-downOut");
          l.eeelement
            .attr("style", l.eeelement.data("original-styles"))
            .css("opacity", "1")
      ...
      slideRevealLeft: function (k, m) {
        ...
        j.slides[k].eeelement
          ...
          .addClass("pogoSlider-animation-leftOut");
        l.eeelement.css({ opacity: 1, "z-index": j.settings.baseZindex });
        return function () {
          j.slides[k].eeelement.removeClass("pogoSlider-animation-leftOut");
        };
      },
      ...
      slideOverLeft: function (j, l) {
        ...
        return function () {
          k.eeelement
            .attr("style", k.eeelement.data("original-styles"))
            .css("opacity", "1")
            .removeClass("pogoSlider-animation-leftIn");
        };
      },
      ...
      expandReveal: function (k, m) {
        var j = this;
        var l = j.slides[m];
        j.eeelement.css("overflow", "visible");
        j.slides[k].eeelement
          .precss({
            "*z-index": j.settings.baseZindex + 1,
            "animation-duration": l.duration + "ms",
        ...
        l.eeelement.css({ opacity: 1, "z-index": j.settings.baseZindex });
        return function () {
          j.eeelement.css("overflow", "");
          j.slides[k].eeelement.removeClass("pogoSlider-animation-expandReveal");
        };
      },
      shrinkReveal: function (k, m) {
        ...
        l.eeelement.css({ opacity: 1, "z-index": j.settings.baseZindex });
        return function () {
          j.slides[k].eeelement.removeClass("pogoSlider-animation-shrinkReveal");
        };
      },
      verticalSplitReveal: function (l, n) {
        var k = this;
        var m = k.slides[n];
        k.slides[l].eeelement.css("z-index", k.settings.baseZindex + 1);
        m.eeelement.css({ opacity: 1, "z-index": k.settings.baseZindex });
        k._createSlideSlices(l, 1, 2);
        var j = k.slides[l].eeelement.find(".pogoSlider-slide-slice");
      ...
      zipReveal: function (l, n) {
        ...
        k.slides[l].eeelement.css("z-index", k.settings.baseZindex + 1);
        m.eeelement.css({ opacity: 1, "z-index": k.settings.baseZindex });
        k._createSlideSlices(l, 1, Math.round(k.eeelement.width() / 100));
        var j = k.slides[l].eeelement.find(".pogoSlider-slide-slice");
        j.precss("animation-duration", m.duration + "ms");
        j.each(function (o) {
          if (o % 2 === 0) {
      ...
      barReveal: function (o, q, n) {
        var k = this;
        var p = k.slides[q];
        k.slides[o].eeelement.css("z-index", k.settings.baseZindex + 1);
        p.eeelement.css({ opacity: 1, "z-index": k.settings.baseZindex });
        k._createSlideSlices(o, 1, Math.round(k.eeelement.width() / 100));
        var j = k.slides[o].eeelement.find(".pogoSlider-slide-slice");
      ...
      blocksReveal: function (k, j) {
        ...
        if (u.settings.preserveTargetSize) {
          t = parseFloat(u.eeelement.css("padding-bottom"));
        } else {
          t = u.eeelement.height();
        }
        var r = Math.round(t / 100);
        var l = Math.round(u.eeelement.width() / 100);
        u.slides[k].eeelement.css("z-index", u.settings.baseZindex + 1);
        q.eeelement.css({ opacity: 1, "z-index": u.settings.baseZindex });
        var p = u._generateARandomArray(r * l);
        u._createSlideSlices(k, r, l);
        var n = u.slides[k].eeelement.find(".pogoSlider-slide-slice");
      ...
      foldRight: function (l, k) {
        ...
        var q = s.slides[k];
        var m = s.slides[l];
        s.eeelement.css("overflow", "visible");
        m.eeelement.css({
          overflow: "visible",
        ...
        var r = m.eeelement.find(".pogoSlider-slide-slice");
        s._createSlideSlices(k, 1, 2);
        var o = s.slides[k].eeelement.find(".pogoSlider-slide-slice");
        var n = r.eq(0);
        var p = o.eq(0);
        var j = o.eq(1);
        q.eeelement.prepend(n.detach());
        m.eeelement.prepend(p.detach());
        ...
        return function () {
          s.eeelement.css("overflow", "");
          q.eeelement.prepend(p.detach());
          m.eeelement.prepend(n.detach());
      ...
      foldLeft: function (l, k) {
        ...
        var r = m.eeelement.find(".pogoSlider-slide-slice");
        s._createSlideSlices(k, 1, 2);
        var n = s.slides[k].eeelement.find(".pogoSlider-slide-slice");
        var p = r.eq(1);
        var o = n.eq(0);
        var j = n.eq(1);
        q.eeelement.append(p.detach());
        m.eeelement.append(j.detach());
    ...
    compatSlideTransitions: {
      fade: function (j, l) {
        var k = this.slides[l];
        this.slides[j].eeelement.animate({ opacity: 0 }, k.duration);
        k.eeelement.animate({ opacity: 1 }, k.duration);
      },
      slide: function (j, k) {
        var l;
      ...
      slideLeft: function (j, l) {
        var k = this.slides[l];
        this.slides[j].eeelement.animate({ left: "-100%" }, k.duration);
        k.eeelement
      ...
      slideUp: function (j, l) {
        var k = this.slides[l];
        this.slides[j].eeelement.animate({ top: "-100%" }, k.duration);
        k.eeelement
      ...
      slideRevealLeft: function (j, l) {
        var k = this.slides[l];
        this.slides[j].eeelement
          .css("z-index", this.settings.baseZindex + 1)
          .animate({ left: "-100%" }, k.duration);
        k.eeelement.css({ opacity: 1, "z-index": this.settings.baseZindex });
      },
      ...
      zipReveal: function (n, p) {
        var m = this;
        var o = m.slides[p];
        m.slides[n].eeelement.css("z-index", m.settings.baseZindex + 1);
        o.eeelement.css({ opacity: 1, "z-index": m.settings.baseZindex });
        m._createSlideSlices(n, 1, Math.round(m.eeelement.width() / 100));
        var l = m.slides[n].eeelement.find(".pogoSlider-slide-slice");
      ...
      barReveal: function (o, q, n) {
        var m = this;
        var p = m.slides[q];
        m.slides[o].eeelement.css("z-index", m.settings.baseZindex + 1);
        p.eeelement.css({ opacity: 1, "z-index": m.settings.baseZindex });
        m._createSlideSlices(o, 1, Math.round(m.eeelement.width() / 100));
        var l = m.slides[o].eeelement.find(".pogoSlider-slide-slice");
