    ...
    <div class="page-blog-details-area">
        <div class="container">
            <div class="row">
                ...
                $db->where("langID", LANGID);
                $db->where("catID", 0);
                $mainCat = $db->getOne("educationcat");

                $db->where("catID", $mainCat['id']);
                $subCat = $db->get("educationcat");
                                    ...
                                    <div class="test">
                                        <ul class="bullet-list">
                                            <?php
                                                ...
                                                $subCat1 = $db->get("educationcat");
                                                foreach ($subCat1 as $item1) {
                                                    $db->where("catID", $item1['id']);
                                                    $subCat2 = $db->get("educationcat");


                                                    $db->where("type", "cat");
                                                    $db->where("type_meta", $item1['id']);
                                                    $postcount = $db->get("education_meta");
                                                    ...
                                                    if (count($subCat2) > 0) {
                                                        ...
                                                        foreach ($subCat2 as $item2) {
                                                            ...
                                                            $subCat3 = $db->get("educationcat");
                                                            if (count($subCat3) > 0) {
                                                                //echo '<li>' . count($postcount) . '<a class="links" href="' . $caturl['url'] . '/' . $item2['url'] . '/">' . $item2['title'] . '</a>';
                                                                if (count($postcount) == 1) {
                                                                ...
                                                                foreach ($subCat3 as $item3) {
                                                                    ...
                                                                    //echo '<li>' . count($postcount) . '<a class="links" href="' . $caturl['url'] . '/' . $item3['url'] . '/">' . $item3['title'] . '</a></li>';
                                                                }
                                                                echo '</ul>';
                                                                echo '</li>';
                                                            } else {
                                                                ...
                                                                //echo '<li>' . count($postcount) . '<a  class="links" href="' . $caturl['url'] . '/' . $item2['url'] . '/">' . $item2['title'] . '</a></li>';
                                                            }
                                                        }
                                                        echo '</ul>';
                                                        echo '</li>';
                                ...
                                <div class="col-lg-4">
                                    <?php
                                        ...
                                        if ($item['resim'] == "") {
                                            ...
                                            echo '<img alt="' . $item['title'] . '" src="' . BWPUP . 'egitim/' . $gen . 'x' . $yuk . '/' . $item['resim'] . '" />';
                                        }
                                        ?>
                                </div>
                            </div>
